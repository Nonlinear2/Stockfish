...
// accessed by [depth][ttData.move | ttData.value > alpha | ttData.depth >= depth 
//              | opponentWorsening | improving | ss->ttPv | PvNode | cutNode | ttCapture]
using ReductionHistory = Stats<std::int16_t, 7183, MAX_PLY, 512>;
