...
Value Search::Worker::search(
  Position& pos, Stack* ss, Value alpha, Value beta, Depth depth, bool cutNode) {
    ...
    else if (ss->ttHit)
    {
        ...
        tunedStaticEval1 = std::clamp(unadjustedStaticEval + 33*correctionValue / 4194304,
                VALUE_TB_LOSS_IN_MAX_PLY + 1, VALUE_TB_WIN_IN_MAX_PLY - 1);
        tunedStaticEval2 = std::clamp(unadjustedStaticEval + 30*correctionValue / 4194304,
                VALUE_TB_LOSS_IN_MAX_PLY + 1, VALUE_TB_WIN_IN_MAX_PLY - 1);
        tunedStaticEval3 = std::clamp(unadjustedStaticEval + 32*correctionValue / 4194304,
                VALUE_TB_LOSS_IN_MAX_PLY + 1, VALUE_TB_WIN_IN_MAX_PLY - 1);
...
Value Search::Worker::qsearch(Position& pos, Stack* ss, Value alpha, Value beta) {
    ...
    else
    {
        ...
        if (ss->ttHit)
        {
            ...
            tunedStaticEval = std::clamp(unadjustedStaticEval + 31*correctionValue / 8388608,
                VALUE_TB_LOSS_IN_MAX_PLY + 1, VALUE_TB_WIN_IN_MAX_PLY - 1);
        ...
        else
        {
            ...
            tunedStaticEval = std::clamp(unadjustedStaticEval + 31*correctionValue / 4194304,
                VALUE_TB_LOSS_IN_MAX_PLY + 1, VALUE_TB_WIN_IN_MAX_PLY - 1);
        }
